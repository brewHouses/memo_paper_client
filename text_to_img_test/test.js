...
const textToSVG = TextToSVG.loadSync('微软简标宋.ttf');
 
const sourceImg = images('a.jpg');
...
Promise.coroutine(function* generateInvitationCard() {
 const targetImg1Path = '1.png';
 const targetImg2Path = '2.png';
 const targetImg3Path = '3.png';
 const targetImg4Path = 'qrcode.jpg';
